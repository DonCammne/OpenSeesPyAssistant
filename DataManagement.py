...
class DataManagement(ABC):
    ...
    def ShowInfo(self):
        ...
        In some cases, it possible to plot some information (for example the curve of the material model).
        """
        pass
    ...
    def ReInit(self):
        """
        Abstract method that computes the value of the parameters that are computed with respect of the arguments. \n
    ...
    def UpdateStoredData(self):
        ...
        This member variable (self.data) is a list of lists with 2 entries (info_name and info_value)
            and for each list is stored a different memeber variable of the class. \n
